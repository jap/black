...
assert sys.version_info >= (3, 6, 2), 'blacq requires Python 3.6.2+'
...
setup(
    ...
    description='The uncompromising code formatter with sensible quotes.',
    ...
    entry_points={
        'console_scripts': [
            'blacq=black:patched_main',
            'blacqd=blackd:patched_main [d]',
            'blacq-primer=black_primer.cli:main',
        ]
    },
)
